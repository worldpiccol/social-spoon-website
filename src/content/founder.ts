/**
 * Founder profile. Replace `bio` when the client sends the real copy.
 * Do not invent biography details beyond what is already on the site.
 */
export const founder = {
  name: "Miss Prisca Chukwu",
  role: "Founder & CEO",
  image: {
