...
export const serviceWorkProof: WorkProof[] = [
  ...
  {
    title: "You're back on Facebook",
    caption: "Suspended Facebook account is no longer suspended.",
    src: "/images/testimonials/facebook-reinstated.jpg",
    width: 1080,
    height: 1350,
  },
  {
    title: "Facebook account restored",
    caption: "Facebook account reviewed and no longer suspended.",
    src: "/images/testimonials/facebook-no-longer-suspended.jpg",
    width: 1080,
    height: 1350,
  },
  {
    title: "Disabled Instagram reinstated",
    caption: "Disabled Instagram account reinstated after appeal.",
    src: "/images/testimonials/disabled-instagram-sonmade-luxury.jpg",
    width: 1429,
    height: 2000,
  },
  {
    title: "Disabled Instagram recovered",
    caption: "Disabled Instagram account recovered and usable again.",
    src: "/images/testimonials/disabled-instagram-dryside.jpg",
    width: 1080,
    height: 1350,
  },
  {
